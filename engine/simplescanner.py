...
class SimpleScanner:
    ...
    def __init__(self):
        ...
        self._marker_top_left_id = 2
        self._marker_top_right_id = 1
        self._marker_bottom_left_id = 4
        self._marker_bottom_right_id = 3
    ...
    def scan(
        ...
        """
        Scan creature from image represented by ndarray
        :param frame: Photo of a creature from an opencv image
        :return: Aligned image of a creature
        """
    ...
    def remove_background(
        ...
        :param frame: Aligned image of a creature
...
if __name__ == '__main__':
    ...
    for filename in files:
        ...
        cv2.imshow('creature', processed_frame)
        cv2.waitKey(0)
