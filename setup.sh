...
main() {
    echo -e "${BLUE}🎃 Setting up HalloweenScanner...${NC}"
    ...
    echo -e "${GREEN}✨ HalloweenScanner has been successfully installed!${NC}"
    echo
    echo "To start using HalloweenScanner:"
